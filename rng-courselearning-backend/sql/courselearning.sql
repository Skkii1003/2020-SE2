...
CREATE TABLE `course_posts`  (
                                 ...
                                 `last_ctime` varchar(255) NOT NULL DEFAULT 0,
                                 PRIMARY KEY (`course_id`, `user_id`,`ctime`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
-- ----------------------------
...
CREATE TABLE `post_comments`  (
                                 ...
                                 PRIMARY KEY (`course_id`, `user_id`,`ctime`,`comment_id`,`comment_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
-- ----------------------------
-- Records of post_notices
-- ----------------------------
DROP TABLE IF EXISTS `post_notices`;
CREATE TABLE `post_notices`  (
                                  `sender_id` int(11) NOT NULL,
                                  `receiver_id` int(11) NOT NULL,
                                  `send_time` varchar(255) NOT NULL,
                                  `url` varchar(400) NOT NULL ,
                                  PRIMARY KEY (`sender_id`,`send_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;